...
(function (window, document) {
  ...
  const PLATE_GRADIENTS = [
    'linear-gradient(155deg, rgba(155,93,229,0.22), rgba(34,14,54,0.92))',
    'linear-gradient(155deg, rgba(255,215,106,0.16), rgba(24,11,38,0.94))',
    'linear-gradient(155deg, rgba(201,168,240,0.18), rgba(27,12,40,0.92))',
    'linear-gradient(155deg, rgba(255,138,122,0.12), rgba(20,10,34,0.94))',
    'linear-gradient(155deg, rgba(155,93,229,0.14), rgba(255,215,106,0.07), rgba(20,9,34,0.94))',
    'linear-gradient(155deg, rgba(201,168,240,0.1), rgba(15,6,26,0.95))'
  ];
